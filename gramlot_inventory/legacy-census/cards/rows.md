...
Direct construction/delegation targets found in the Python bodies: `rows`.

## Common parameters

### `genropy/gnrpy/gnr/web/gnrwebstruct/gridstruct.py::GnrGridStruct::rows:L86`
...
- **Forwarded keyword names:** `cellClasses`, `classes`, `headerClasses`

`**kwargs` is not a closed parameter set. The declaration forwards or interprets additional names; user-defined callbacks, prefixed attributes and downstream widget/server consumers can extend it. Only statically discoverable names are listed above.

## Behavior, output and errors

- `genropy/gnrpy/gnr/web/gnrwebstruct/gridstruct.py::GnrGridStruct::rows:L86`: TODO :param classes: TODO :param cellClasses: TODO :param headerClasses: TODO
