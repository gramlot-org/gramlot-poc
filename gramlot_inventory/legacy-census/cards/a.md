...
Direct construction/delegation targets found in the Python bodies: `a`.

## Common parameters

### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::a:L746`
...
### `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::a:L127`
...
- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::a:L746`: No behavior docstring is present in the primary declaration.
- `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::a:L127`: HTML anchor (link) element.
