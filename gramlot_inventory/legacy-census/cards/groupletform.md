...
Direct construction/delegation targets found in the Python bodies: `groupletform`.

## Common parameters

### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::groupletform:L844`
...
- **Forwarded keyword names:** `handler`, `value`

`**kwargs` is not a closed parameter set. The declaration forwards or interprets additional names; user-defined callbacks, prefixed attributes and downstream widget/server consumers can extend it. Only statically discoverable names are listed above.

## Behavior, output and errors

- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::groupletform:L844`: No behavior docstring is present in the primary declaration.
