...
Direct construction/delegation targets found in the Python bodies: `grouplet`.

## Common parameters

### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::grouplet:L841`
...
- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::grouplet:L841`: No behavior docstring is present in the primary declaration.
