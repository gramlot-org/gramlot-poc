...
### `genropy/gnrpy/gnr/web/widgets/dijit.py::DijitWidgets::horizontalSlider:L260`
...
- Current Gramlot name-level evidence: `js/dom/src/components/builtin-components.json`, `src/gramlot/grammar/inputs.py:L54`.
