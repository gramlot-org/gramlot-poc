...
### `genropy/gnrpy/gnr/web/widgets/dojox.py::DojoxWidgets::dojoGrid:L493`

| Parameter | Type | Presence | Default | Bindings | Constraints / consumer |
| --- | --- | --- | --- | --- | --- |
| `model` | str \| None | optional | `None` | Legacy Source binding syntax may be accepted; exact consumer must be followed. | Data model (string name or object). |
