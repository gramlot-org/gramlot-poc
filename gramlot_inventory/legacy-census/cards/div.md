...
### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::div:L734`
...
### `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::div:L30`
...
- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::div:L734`: No behavior docstring is present in the primary declaration.
- `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::div:L30`: HTML div container element.
...
- Current Gramlot name-level evidence: `src/gramlot/grammar/native_html.py:L14`.
