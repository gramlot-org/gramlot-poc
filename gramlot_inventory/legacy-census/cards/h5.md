...
Direct construction/delegation targets found in the Python bodies: `h5`.

## Common parameters

### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::h5:L713`
...
### `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::h5:L112`
...
- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::h5:L713`: No behavior docstring is present in the primary declaration.
- `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::h5:L112`: HTML heading level 5.
