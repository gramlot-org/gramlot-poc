# formstore_handler_addcallback

## Identity

- **Identity:** `formstore_handler_addcallback`
...
### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::formstore_handler_addcallback:L451`
...
- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::formstore_handler_addcallback:L451`: TODO :param cb: TODO
...
root.formstore_handler_addcallback(...)
```
