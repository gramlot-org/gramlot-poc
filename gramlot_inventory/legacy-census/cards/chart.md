...
### `genropy/gnrpy/gnr/web/widgets/dojox.py::DojoxWidgets::chart:L437`
...
- `genropy/gnrpy/gnr/web/widgets/dojox.py::DojoxWidgets::chart:L437`: Dojox charting widget placeholder for Chart2D/Chart3D integration.
...
- Current Gramlot name-level evidence: `js/dom/src/components/builtin-components.json`, `src/gramlot/grammar/widgets.py:L38`.
