...
Direct construction/delegation targets found in the Python bodies: `h2`.

## Common parameters

### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::h2:L704`
...
### `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::h2:L97`
...
- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::h2:L704`: No behavior docstring is present in the primary declaration.
- `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::h2:L97`: HTML heading level 2.
