...
Direct construction/delegation targets found in the Python bodies: `caption`.

## Common parameters

### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::caption:L755`
...
### `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::caption:L315`
...
- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::caption:L755`: No behavior docstring is present in the primary declaration.
- `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::caption:L315`: HTML table caption element.
