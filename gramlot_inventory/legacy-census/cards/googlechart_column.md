...
### `genropy/gnrpy/gnr/web/gnrwebstruct/dojo11.py::GnrDomSrc_dojo_11::googlechart_column:L540`
...
- **Consumed kwargs:** `columns`

- **Forwarded keyword names:** `dtype`, `field`, `name`

`**kwargs` is not a closed parameter set. The declaration forwards or interprets additional names; user-defined callbacks, prefixed attributes and downstream widget/server consumers can extend it. Only statically discoverable names are listed above.

## Behavior, output and errors

- `genropy/gnrpy/gnr/web/gnrwebstruct/dojo11.py::GnrDomSrc_dojo_11::googlechart_column:L540`: No behavior docstring is present in the primary declaration.
