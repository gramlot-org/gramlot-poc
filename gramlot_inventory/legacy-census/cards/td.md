...
Direct construction/delegation targets found in the Python bodies: `td`.

## Common parameters

### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::td:L722`
...
### `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::td:L345`
...
- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::td:L722`: No behavior docstring is present in the primary declaration.
- `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::td:L345`: HTML table data cell element.
