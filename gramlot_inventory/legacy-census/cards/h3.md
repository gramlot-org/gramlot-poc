...
Direct construction/delegation targets found in the Python bodies: `h3`.

## Common parameters

### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::h3:L707`
...
### `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::h3:L102`
...
- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::h3:L707`: No behavior docstring is present in the primary declaration.
- `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::h3:L102`: HTML heading level 3.
