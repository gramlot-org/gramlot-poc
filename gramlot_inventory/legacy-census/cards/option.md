...
Direct construction/delegation targets found in the Python bodies: `option`.

## Common parameters

### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::option:L752`
...
### `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::option:L293`
...
- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::option:L752`: No behavior docstring is present in the primary declaration.
- `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::option:L293`: HTML option element for select.
