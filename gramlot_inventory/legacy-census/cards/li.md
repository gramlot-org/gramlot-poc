...
Direct construction/delegation targets found in the Python bodies: `li`.

## Common parameters

### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::li:L719`
...
### `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::li:L251`
...
- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::li:L719`: No behavior docstring is present in the primary declaration.
- `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::li:L251`: HTML list item element.
