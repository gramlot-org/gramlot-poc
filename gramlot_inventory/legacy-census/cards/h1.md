...
Direct construction/delegation targets found in the Python bodies: `h1`.

## Common parameters

### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::h1:L701`
...
### `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::h1:L92`
...
- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::h1:L701`: No behavior docstring is present in the primary declaration.
- `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::h1:L92`: HTML heading level 1.
