...
### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::semaphore:L764`
...
- **Forwarded keyword names:** `dtype`, `format`, `innerHTML`

`**kwargs` is not a closed parameter set. The declaration forwards or interprets additional names; user-defined callbacks, prefixed attributes and downstream widget/server consumers can extend it. Only statically discoverable names are listed above.
### `genropy/gnrpy/gnr/web/widgets/genro.py::GenroWidgets::Semaphore:L947`
...
- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::semaphore:L764`: No behavior docstring is present in the primary declaration.
- `genropy/gnrpy/gnr/web/widgets/genro.py::GenroWidgets::Semaphore:L947`: Visual semaphore indicator (red/yellow/green status). Args: **kwargs: value, colors, _class.
