...
Direct construction/delegation targets found in the Python bodies: `h6`.

## Common parameters

### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::h6:L716`
...
### `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::h6:L117`
...
- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::h6:L716`: No behavior docstring is present in the primary declaration.
- `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::h6:L117`: HTML heading level 6.
