...
Direct construction/delegation targets found in the Python bodies: `dt`.

## Common parameters

### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::dt:L749`
...
### `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::dt:L261`
...
- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::dt:L749`: No behavior docstring is present in the primary declaration.
- `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::dt:L261`: HTML description term element.
