...
### `genropy/gnrpy/gnr/web/widgets/genro.py::GenroWidgets::Palette:L320`
...
- `genropy/gnrpy/gnr/web/widgets/genro.py::GenroWidgets::Palette:L320`: Floating palette window — draggable, resizable popup panel. Args: **kwargs: paletteCode, title, dockTo, width, height, _class.
...
- Current Gramlot name-level evidence: `js/dom/src/components/builtin-components.json`, `src/gramlot/grammar/widgets.py:L13`.
