...
### `genropy/gnrpy/gnr/web/widgets/genro.py::GenroWidgets::CallBackSelect:L101`
...
- `genropy/gnrpy/gnr/web/widgets/genro.py::GenroWidgets::CallBackSelect:L101`: Select widget that uses a custom callback method for options. Args: **kwargs: Callback configuration and standard select attrs.
...
- Current Gramlot name-level evidence: `js/dom/src/components/builtin-components.json`, `src/gramlot/grammar/inputs.py:L34`.
