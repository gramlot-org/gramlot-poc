...
Direct construction/delegation targets found in the Python bodies: `form`.

## Common parameters

### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::htmlform:L698`
...
- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::htmlform:L698`: No behavior docstring is present in the primary declaration.
