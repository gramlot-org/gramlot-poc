...
Direct construction/delegation targets found in the Python bodies: `treegrid_column`.

## Common parameters

### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::treegrid_column:L426`
...
- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::treegrid_column:L426`: No behavior docstring is present in the primary declaration.
