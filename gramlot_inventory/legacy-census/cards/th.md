...
Direct construction/delegation targets found in the Python bodies: `th`.

## Common parameters

### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::th:L725`
...
### `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::th:L340`
...
- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::th:L725`: No behavior docstring is present in the primary declaration.
- `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::th:L340`: HTML table header cell element.
