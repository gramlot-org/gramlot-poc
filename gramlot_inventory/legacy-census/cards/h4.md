...
Direct construction/delegation targets found in the Python bodies: `h4`.

## Common parameters

### `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::h4:L710`
...
### `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::h4:L107`
...
- `genropy/gnrpy/gnr/web/gnrwebstruct/base.py::GnrDomSrc::h4:L710`: No behavior docstring is present in the primary declaration.
- `genropy/gnrpy/gnr/web/widgets/html.py::HtmlWidgets::h4:L107`: HTML heading level 4.
