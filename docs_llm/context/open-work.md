...
Full historical decision coverage remains in the expanded view: [open-work.md](../../docs/context/open-work.md). This initial mirror covers the new BagDB decision only; legacy mirror migration is pending.
